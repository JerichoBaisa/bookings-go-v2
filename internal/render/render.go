...
// template.FuncMap allows us to do is to specify the certain functions that are available to our golang template
...
// HumanDate return time in yyyy-mm-dd
...
func Template(w http.ResponseWriter, r *http.Request, tmpl string, td *models.TemplateData) error {
	...
	t, ok := tc[tmpl]
	if !ok {
		return errors.New("can't get template from cache !ok")
	}
