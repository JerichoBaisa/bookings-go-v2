...
import (
	...
	"bitbucket.org/JerichoBaisa/bookings-go-v2/internal/handlers"
...
func main() {
	...
	appmessage := fmt.Sprintf("Starting application on port %s", portNumber)
...
func run() (*driver.DB, error) {
	// what am I going to put in my session - we need to tell our application abotu the kinds of things we're going to store into the session
